...
public class AccountService : IAccountService
{
    ...
    public AccountService(EatFormDbContext dbContext, IMapper mapper, IPasswordHasher<User> passwordHasher, IConfiguration configuration)
    {
    ...
    public TokenResponseDto GenerateToken(LoginDto dto)
    {
        ...
        if (user == null)
        {
            throw new Exception("Podano zły email lub hasło");
        }
